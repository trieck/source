...
public class TCipher {
	...
	private static final char key_table[] = {
	...
	public static String encipher(String s, int key) {
		char c, output[] = new char[s.length()];
	...
	public static void main(String[] args) {
		...
		String enc = TCipher.encipher(args[0], 0xCAFEBABE);
