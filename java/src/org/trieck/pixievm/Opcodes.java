...
public class Opcodes {
    ...
    /**
     * The following rules are used in encoding instructions
    ...
    private static final Object[] CALL = { "CALL", AM_R16 | AM_M16 | AM_IMM8 | AM_IMM16 };
    ...
    private static final Object[] DEC = { "DEC", AM_R8 | AM_R16 | AM_M8 | AM_M16 };
    private static final Object[] INC = { "INC", AM_R8 | AM_R16 | AM_M8 | AM_M16 };
    ...
    private static final Object[] JMP = { "JMP", AM_M8 | AM_IMM8 | AM_R16 | AM_R16 | AM_IMM16 };
    ...
    private static final Object[][] INSTR = { ADC, AND, BIT, BRK, CALL, CLC, CLI, CMP, DEC, INC, IRET, JCC, JCS, JMP,
        JNZ, JZ, MOV, NOP, OR, POP, PUSH, RET, ROL, ROR, SBB, SEC, SEI, SHL, SHR, XOR};

    /**
     * Register encoding
     *
     * 16bit    8bit    Binary      Decimal
     * -------------------------------------
     *  A       AL      0000        00
     *  B       AH      0001        01
     *  C       BL      0010        02
     ...
     *
     * ADC_R8_R8        =   ADC_BASE_OPCODE
     * ADC_R8_IMM8      =   ADC_BASE_OPCODE + 1
     * ADC_R16_R16      =   ADC_R8_IMM8 + MAX_REG_ENCODING
     * ADC_M16_R16      =   ADC_R16_R16 + 1
     * ADC_R16_M16      =   ADC_M16_R16 + 1
     * ADC_R16_IMM16    =   ADC_16_M16
     * ...
     *
     */

    /*
     * Here is an example of encoding an opcode and it's operands.
     * Consider the general form of ADC with two 8-bit registers:
     *
     * ADC R8, R8       0x00    R
     *
     * Now considering the specific example:
     *
     * ADC AL, BL       0x00    0000 0010
     *                  0x00    0x02
     *
        ...
        for (int i = 0; i < INSTR.length; i++) {
            for (int j = 0; j < MODES.length; j++) {
                ...
                if ((mode & MODES[j]) != 0) {
                    switch (MODES[j]) {
                    case AM_IMPLIED:
                        System.out.println(INSTR[i][0]);
                        break;
                    case AM_R8:
                        System.out.println(INSTR[i][0] + " R8");
                        break;
                    case AM_M8:
                        System.out.println(INSTR[i][0] + " M8");
                        break;
                    case AM_IMM8:
                        System.out.println(INSTR[i][0] + " IMM8");
                        break;
                    case AM_R16:
                        System.out.println(INSTR[i][0] + " R16");
                        break;
                    case AM_M16:
                        System.out.println(INSTR[i][0] + " M16");
                        break;
                    case AM_IMM16:
                        System.out.println(INSTR[i][0] + " IMM16");
                        break;
                    case AM_R8_R8:
                        System.out.println(INSTR[i][0] + " R8, R8");
                        break;
                    case AM_R8_IMM8:
                        System.out.println(INSTR[i][0] + " R8, IMM8");
                        break;
                    case AM_R16_R16:
                        System.out.println(INSTR[i][0] + " R16, R16");
                        break;
                    case AM_M16_R16:
                        System.out.println(INSTR[i][0] + " M16, R16");
                        break;
                    case AM_R16_M16:
                        System.out.println(INSTR[i][0] + " R16, M16");
                        break;
                    case AM_R16_IMM16:
                        System.out.println(INSTR[i][0] + " R16, IMM16");
                        break;
                    }
                }
            }
