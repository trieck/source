...
public class PreparedStmt {
    ...
    public PreparedStmt(Connection conn, String sql, int type, int concurr) throws SQLException {
    ...
    void prepare(int index, Recordset.Param param) {
        try {
            ...
            default:
                throw new IllegalArgumentException("unsupported java.sql.Types type");
            }
        } catch (SQLException e) {
            System.err.println(e);
        }
