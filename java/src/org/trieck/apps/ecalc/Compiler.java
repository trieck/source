...
public class Compiler {
     ...
     * @param get whether to get next token
     */
    private void compexpr(boolean get)
            throws CompilerException {
        shiftexpr(get);
     ...
     * @param get whether to get next token
     */
    private void shiftexpr(boolean get)
            throws CompilerException {
        addexpr(get);
     ...
     * @param get whether to get next token
     */
    private void addexpr(boolean get)
            throws CompilerException {
        multexpr(get);
     ...
     * @param get whether to get next token
     */
    private void multexpr(boolean get)
            throws CompilerException {
        prim(get);
     ...
     * @param get whether to get next token
     */
    private void prim(boolean get)
            throws CompilerException {
        if (get) tok = lexer.gettok();
    ...
    private void symbol()
            throws CompilerException {
        Symbol symbol = Symbols.lookup(tok.value);
     ...
     */
    private void builtin(Symbol symbol)
            throws CompilerException {
        prim(true);
     ...
     */
    private void keyword(Symbol symbol)
            throws CompilerException {
     ...
     */
    private void call(Symbol symbol)
            throws CompilerException {
     ...
     */
    private void var(Symbol symbol)
            throws CompilerException {
     ...
     */
    private void argassign(int narg)
            throws CompilerException {
        expr(true);
