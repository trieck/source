...
public class ODBClient {
    ...
    public String makePool() throws IOException, UnknownHostException {
        ...
        BEDictionary request = new BEDictionary();
        request.set(Protocol.KEY_REQUEST_FNC, Protocol.FNC_MKPOOL);

        // send request to server
        BEDictionary response = sendRequest(request);
        checkError(response);
     ...
     * @throws UnknownHostException
     */
    String createObject(String poolid, int type) throws IOException, UnknownHostException {
     ...
     * @throws UnknownHostException
     */
    String createObject(String poolid, BEObject object) throws IOException, UnknownHostException {
    ...
    /**
     * Create a new object in the pool
     * with initial value, specifying key
     *
     * @param poolid
     * @param key
     * @param object
     ...
     * @throws UnknownHostException
     */
    String createObject(String poolid, String key, BEObject object) throws IOException, UnknownHostException {
    ...
    String createString(String poolid, String val) throws IOException, UnknownHostException {
        return createObject(poolid, new BEString(val));
    }

    String createString(String poolid, String key, String val) throws IOException, UnknownHostException {
     ...
     * @throws UnknownHostException
     */
    void destroyObject(String poolid, String objectid) throws IOException, UnknownHostException {
    ...
    BEObject getObject(String poolid, String objectid) throws IOException, UnknownHostException {
    ...
    String getString(String poolid, String objectid) throws IOException, UnknownHostException {

        BEObject object = getObject(poolid, objectid);
    ...
    void setObject(String poolid, String objectid, BEObject val) throws IOException, UnknownHostException {
    ...
    void setString(String poolid, String objectid, String val) throws IOException, UnknownHostException {
    ...
    private void checkError(BEDictionary response) throws IOException {
        long ncode = response.getInt(Protocol.KEY_RESPONSE_CD);
     ...
     * @throws UnknownHostException
     */
    private BEDictionary sendRequest(BEDictionary request) throws IOException, UnknownHostException {
        ...
        BEObject response = BEDecoder.decode(is);
