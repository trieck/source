...
public class StatusPanel extends JPanel {
    ...
    private static final Font STATUS_FONT = new Font("Arial",
    ...
    private void init() {
        ...
        setFont(STATUS_FONT);
        final FontMetrics fm = getFontMetrics(STATUS_FONT);
        setBorder(BorderFactory.createEtchedBorder());
        final Insets insets = getInsets();
        setPreferredSize(new Dimension(0, fm.getHeight() + insets.top
                + insets.bottom));
        setOpaque(true);
    }
    ...
    private void drawGripper(Graphics2D g) {
        ...
        final int x = GRIPPER_OFFSET_X;
        final int y = GRIPPER_OFFSET_Y;
        final int cy = rect.height - (GRIPPER_OFFSET_Y * 2);
