...
instr:		I1 R8  ',' R8 		{ code3(AM_RR8, $1, $2, $4); }	
		...
		|	I1 BYTE M16 ',' IM8	{ code3(AM_M8I8, $1, $3, $5); }
		|	I1 WORD M16 ',' IM8	{ code3(AM_M16I8, $1, $3, $5); }
		|	I1 M16 ',' IM16		{ code3(AM_MI16, $1, $2, $4); }		
        |	I1 A16 ',' R8		{ code3(AM_AR8, $1, $2, $4); }	
        |	I1 A16 ',' R16		{ code3(AM_AR16, $1, $2, $4); }	
        |	I1 BYTE A16 ',' IM8	{ code3(AM_A8I8, $1, $3, $5); }	
        |	I1 WORD A16 ',' IM8	{ code3(AM_A16I8, $1, $3, $5); }	
        |	I1 A16 ',' IM16		{ code3(AM_AI16, $1, $2, $4); }	
        |	I2 R8				{ code2(AM_R8, $1, $2); }	
        |	I2 R16				{ code2(AM_R16, $1, $2); }
        |	I2 BYTE M16			{ code2(AM_M8, $1, $3); }
        |	I2 WORD M16			{ code2(AM_M16, $1, $3); }
        |	I2 BYTE A16			{ code2(AM_A8, $1, $3); }
        |	I2 WORD A16			{ code2(AM_A16, $1, $3); }
        ...
        |	I6 BYTE M16			{ code2(AM_M8, $1, $3); }
        |	I6 WORD M16			{ code2(AM_M16, $1, $3); }
        |	I6 BYTE A16			{ code2(AM_A8, $1, $3); }
        |	I6 WORD A16			{ code2(AM_A16, $1, $3); }
        |	I7 R8				{ code2(AM_R8, $1, $2); }
        |	I7 R16				{ code2(AM_R16, $1, $2); }
        |	I7 BYTE M16			{ code2(AM_M8, $1, $3); }
        |	I7 WORD M16			{ code2(AM_M16, $1, $3); }
        |	I7 BYTE A16			{ code2(AM_A8, $1, $3); }
        |	I7 WORD A16			{ code2(AM_A16, $1, $3); }
