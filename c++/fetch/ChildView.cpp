...
static void ParseResource(LPCSTR input, CString & machine, CString & resource);
...
void ParseResource(LPCSTR input, CString & machine, CString & resource)
{
