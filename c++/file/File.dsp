...
# ADD LINK32 user32.lib /nologo /subsystem:windows /machine:I386 /out:"bin\file.exe"
...
# ADD LINK32 user32.lib /nologo /subsystem:windows /debug /machine:I386 /out:"bin\file.exe" /pdbtype:sept
# SUBTRACT LINK32 /pdb:none
