...
void CMainFrame::ResizeFrame(void)
{
	...
	if (IsWindow(m_wndMenuBar)) {
		...
		rcMenu.OffsetRect(-rcMenu.left, -rcMenu.top);
	}
	...
	if (IsWindow(m_wndMenuBar) && !m_wndMenuBar.IsFloating() && m_wndMenuBar.IsWindowVisible()) {
	...
	if (IsWindow(m_wndToolBar) && !m_wndToolBar.IsFloating() && m_wndToolBar.IsWindowVisible()) {
