...
protected:
	...
	inline CComboBox& GetInDeviceList(){ return * (CComboBox*)GetDlgItem(IDC_INPUTDEVICES); }
	inline CComboBox& GetOutDeviceList(){ return * (CComboBox*)GetDlgItem(IDC_OUTPUTDEVICES); }

	inline CButton& GetQueryInput(){ return * (CButton*)GetDlgItem(IDC_QUERYINPUT); }
	inline CButton& GetQueryOutput(){ return * (CButton*)GetDlgItem(IDC_QUERYOUTPUT); }

	inline CComboBox& GetFormatBox(){ return * (CComboBox*)GetDlgItem(IDC_FORMATS); }
