========================================================================
		OLE Control DLL : COLOR BUTTON
========================================================================

ControlWizard has created this project for your COLOR BUTTON OLE Control DLL,
...
that make up your COLOR BUTTON OLE Control DLL.
...
ColorButtonCtl.h
	This file contains the declaration of the CColorButtonCtrl C++ class.

ColorButtonCtl.cpp
	This file contains the implementation of the CColorButtonCtrl C++ class.

ColorButtonPpg.h
	This file contains the declaration of the CColorButtonPropPage C++ class.

ColorButtonPpg.cpp
	This file contains the implementation of the CColorButtonPropPage C++ class.

ColorButtonCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CColorButtonCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file Color Button.rc.
