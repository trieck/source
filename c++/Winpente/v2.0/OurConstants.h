/*-------------------------------------------
	Module	:	OurConstants.h
	Purpose	:	Global Constants
	Date	:	09/01/1997
-------------------------------------------*/

#ifndef _OURCONSTANTS_H_
#define _OURCONSTANTS_H_

#define	MINIMUM_HORZRES		800
#define MINIMUM_VERTRES		600
...
#define FRAME_COLOR 		RGB(255, 255, 0)
...
#define ICON_VOFFSET 		2	// Vertical Pixel Offset

#endif // _OURCONSTANTS_H_