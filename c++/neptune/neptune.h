...
EXTERN_C const IID IID_IComputer;
    ...
    typedef struct IComputerVtbl
    {
        ...
        /* [helpstring][propget] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *get_SystemDirectory )( 
            IComputer __RPC_FAR * This,
            /* [retval][out] */ BSTR __RPC_FAR *pVal);
...
/* [helpstring][propget] */ HRESULT STDMETHODCALLTYPE IComputer_get_SystemDirectory_Proxy( 
    IComputer __RPC_FAR * This,
    /* [retval][out] */ BSTR __RPC_FAR *pVal);
...
EXTERN_C const IID IID_IStringUtil;
    ...
    typedef struct IStringUtilVtbl
    {
        ...
        /* [helpstring][vararg] */ HRESULT ( STDMETHODCALLTYPE __RPC_FAR *FormatString )( 
            IStringUtil __RPC_FAR * This,
            /* [in] */ BSTR fmt,
            /* [out] */ BSTR __RPC_FAR *output,
